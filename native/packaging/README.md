...
```text
powershell -NoProfile -File native/packaging/windows/package.ps1 -Version 0.1.28 -OutputDir dist/native/windows
```
...
```text
bash native/packaging/macos/package.sh 0.1.28 dist/native/macos
```
  ...
  "platforms": {
    "windows-x86_64": {
      "manager": {
        "kind": "cli-manager",
        "arch": "x86_64",
        "path": "origin-speak-0.1.28-windows-x86_64.exe",
        "url": "https://github.com/devrajmahar/origin-speak/releases/download/v0.1.28/origin-speak-0.1.28-windows-x86_64.exe",
        "sha256": "<lowercase hex sha256>"
      },
      "runtime": {
        "kind": "silent-runtime",
        "arch": "x86_64",
        "path": "origin-speak-runtime-0.1.28-windows-x86_64.exe",
        "url": "https://github.com/devrajmahar/origin-speak/releases/download/v0.1.28/origin-speak-runtime-0.1.28-windows-x86_64.exe",
        "sha256": "<lowercase hex sha256>"
      }
    },
    "macos-universal": {
      "manager": {
        "kind": "cli-manager",
        "arch": "universal",
        "path": "origin-speak-0.1.28-macos-universal",
        "url": "https://github.com/devrajmahar/origin-speak/releases/download/v0.1.28/origin-speak-0.1.28-macos-universal",
        "sha256": "<lowercase hex sha256>"
      },
      "runtime": {
        "kind": "app-bundle-zip",
        "arch": "universal",
        "path": "origin-speak-runtime-0.1.28-macos-universal.zip",
        "url": "https://github.com/devrajmahar/origin-speak/releases/download/v0.1.28/origin-speak-runtime-0.1.28-macos-universal.zip",
        "sha256": "<lowercase hex sha256>"
      }
    }
  }

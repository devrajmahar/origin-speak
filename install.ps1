...
try {
    ...
    Write-Host 'Fetching latest Origin Speak release metadata...'
    ...
    Write-Host "Downloading Origin Speak $($manifest.version) CLI..."
    ...
    Write-Host 'Checksums verified. Starting terminal setup...'
    & $managerPath setup
    ...
    Write-Host ''
    Write-Host 'Origin Speak is installed. Open a new terminal and run: origin status'
}
finally {
